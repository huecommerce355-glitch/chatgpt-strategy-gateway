...
def handoff(payload, trace_id=None, request_id=None, session_id=None):
    ...
    trace = {k: value for k, value in (("request_id", request_id), ("trace_id", trace_id), ("session_id", session_id)) if value is not None}
